...
import { Building2Icon, CheckIcon, MinusIcon, RocketIcon } from "lucide-react";
...
const enterpriseFeatures = [
  ...
  "Unlimited seats & organization license",
  "SSO / SAML & custom security review",
  "Custom component & template builds",
  "Dedicated Slack channel + SLA",
  "Onboarding & design consulting",
];
        ...
        <div className="mx-auto grid max-w-6xl gap-6 px-4 md:grid-cols-3 lg:px-8">
          ...
          <BlurFade delay={0.24}>
            <div className="flex h-full flex-col rounded-2xl border bg-card p-8">
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                For organizations with security, scale and support needs.
              </p>
              <p className="mt-6 text-5xl font-semibold tracking-tight">
                Custom
                <span className="text-base font-normal text-muted-foreground">
